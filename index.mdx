...
- **Integrations**: Connect Discord, Telegram, Prometheus AlertManager, Apprise, and custom webhooks.
...
| **Notifications** | Discord, Telegram, Prometheus AlertManager, Apprise, and webhooks | Broad built-in notification support |
